...
scoreGauchePoids(X,Y,P,Poids) :- contactGauche(X,Y,X2,Y2), case(X2,Y2,_), not(case(X2,Y2,P)), caseValue(X,Y,Poids), pointsGauche(X2,Y2,P).
scoreDroitePoids(X,Y,P,Poids) :- contactDroite(X,Y,X2,Y2), case(X2,Y2,_), not(case(X2,Y2,P)), caseValue(X,Y,Poids), pointsDroite(X2,Y2,P).
scoreHautPoids(X,Y,P,Poids) :- contactHaut(X,Y,X2,Y2), case(X2,Y2,_), not(case(X2,Y2,P)), caseValue(X,Y,Poids), pointsHaut(X2,Y2,P).
scoreBasPoids(X,Y,P,Poids) :- contactBas(X,Y,X2,Y2), case(X2,Y2,_), not(case(X2,Y2,P)), caseValue(X,Y,Poids), pointsBas(X2,Y2,P).
scoreHautGauchePoids(X,Y,P,Poids) :- contactHautGauche(X,Y,X2,Y2), case(X2,Y2,_), not(case(X2,Y2,P)), caseValue(X,Y,Poids), pointsHautGauche(X2,Y2,P).
scoreBasGauchePoids(X,Y,P,Poids) :- contactBasGauche(X,Y,X2,Y2), case(X2,Y2,_), not(case(X2,Y2,P)), caseValue(X2,Y,Poids), pointsBasGauche(X2,Y2,P).
scoreHautDroitePoids(X,Y,P,Poids) :- contactHautDroite(X,Y,X2,Y2), case(X2,Y2,_), not(case(X2,Y2,P)), caseValue(X,Y,Poids), pointsHautDroite(X2,Y2,P).
scoreBasDroitePoids(X,Y,P,Poids) :- contactBasDroite(X,Y,X2,Y2), case(X2,Y2,_), not(case(X2,Y2,P)), caseValue(X,Y,Poids), pointsBasDroite(X2,Y2,P).
